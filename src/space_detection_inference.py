...
clf = load('../models/FFT_Classification_space_natural_dataset_{}.bin'.format(KEYBOARD))
scaler = load('../models/std_scaler_space__natural_dataset_{}.bin'.format(KEYBOARD))
